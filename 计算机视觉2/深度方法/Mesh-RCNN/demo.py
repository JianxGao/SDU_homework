...
def get_parser():
    ...
    parser.add_argument("--input", default="../input/tsg.png", help="A path to an input image")
    parser.add_argument("--output", default="../output", help="A directory to save output visualizations")
    parser.add_argument(
