...
def fast_mincut(G):
    ...
    if V <= 6:
        ...
        G2 = Karger_algorithm(G, t)
        return min(fast_mincut(G1),fast_mincut(G2))


@calcute_total_time
def karger_stein_algorithm(G, iteration):
    reuslt_list = []
    for i in range(iteration):
        min_cut = fast_mincut(G)
...
if __name__ == '__main__':
    ...
    iteration = 10
    improved_result = karger_stein_algorithm(G,iteration)
