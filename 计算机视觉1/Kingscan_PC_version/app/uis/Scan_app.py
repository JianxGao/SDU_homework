...
class Scan_APP(QApplication):
    def __init__(self):
        ...
        self.main_Window.ui.action_original_img.triggered.connect(self.a_original_img)
        ...
        self.now_text = []
    def a_original_img(self):
        trans_img = cv2.transpose(self.now_img)
        self.now_img = cv2.flip(trans_img, 1)
        ...
        if self.mode==0:
            ...
            if "增亮" == item.text(0):
                try:
                    ...
                    self.brighter = ImageFunctions(self.now_img).brighter()
                    self.change_fig1_ax1(self.brighter)
            if "暗化" == item.text(0):
                try:
                    self.change_fig1_ax1(self.dimmer)
                except:
                    self.dimmer = ImageFunctions(self.now_img).dimmer()
                    self.change_fig1_ax1(self.dimmer)
            if "灰度图" == item.text(0):
                try:
                    self.change_fig1_ax1(self.graystyle)
                except:
                    self.graystyle = ImageFunctions(self.now_img).graystyle()
                    self.change_fig1_ax1(self.graystyle)
            if "黑白图" == item.text(0):
                try:
                    self.change_fig1_ax1(self.binary)
                except:
                    self.binary = ImageFunctions(self.now_img).binary()
                    self.change_fig1_ax1(self.binary)
            if "SSR" == item.text(0):
                self.main_Window.get_double()
                try:
                    self.change_fig1_ax1(self.SSR)
                except:
                    self.SSR = ImageFunctions(self.now_img).SSR(self.main_Window.sigma)
                    self.change_fig1_ax1(self.SSR)
            ...
            if "直方图均衡化" == item.text(0):
                try:
                    ...
                    self.equalization = ImageFunctions(self.now_img).equalization()
                    self.change_fig1_ax1(self.equalization)
            ...
            if "Clahe" == item.text(0):
                try:
                    ...
                    self.clahe = ImageFunctions(self.now_img).clahe()
                    self.change_fig1_ax1(self.clahe)
            ...
            if "Clahe(YUV)" == item.text(0):
                try:
                    ...
                    self.claheYUV = ImageFunctions(self.now_img).claheYUV()
                    self.change_fig1_ax1(self.claheYUV)
            ...
            if "drag" == item.text(0):
                try:
                    ...
                    self.drag = ImageFunctions(self.now_img).drag()
                    self.change_fig1_ax1(self.drag)
            ...
            if "模糊" == item.text(0):
                try:
                    ...
                    self.blurry = ImageFunctions(self.now_img).blurry()
                    self.change_fig1_ax1(self.blurry)
            ...
            if "平滑" == item.text(0):
                try:
                    ...
                    self.smooth = ImageFunctions(self.now_img).smooth()
                    self.change_fig1_ax1(self.smooth)
            ...
            if "模板增强锐化" == item.text(0):
                try:
                    ...
                    self.reinforce = ImageFunctions(self.now_img).reinforce()
                    self.change_fig1_ax1(self.reinforce)
            ...
            if "USM算法增强锐化" == item.text(0):
                try:
                    ...
                    self.USM = ImageFunctions(self.now_img).USM()
                    self.change_fig1_ax1(self.USM)
            ...
            if "边缘增强" == item.text(0):
                try:
                    ...
                    self.edgeRef = ImageFunctions(self.now_img).edgeRef()
                    self.change_fig1_ax1(self.edgeRef)
            ...
            if "边缘增强超级版" == item.text(0):
                try:
                    ...
                    self.edgeRefPlus = ImageFunctions(self.now_img).edgeRefPlus()
                    self.change_fig1_ax1(self.edgeRefPlus)
            ...
            if "轮廓获取" == item.text(0):
                try:
                    ...
                    self.contour = ImageFunctions(self.now_img).contour()
                    self.change_fig1_ax1(self.contour)
            ...
            if "边缘检测" == item.text(0):
                try:
                    ...
                    self.edgeGet = ImageFunctions(self.now_img).edgeGet()
                    self.change_fig1_ax1(self.edgeGet)
            ...
            if "Otsu" == item.text(0):
                try:
                    ...
                    self.Otsu = ImageFunctions(self.now_img).Otsu()
                    self.change_fig1_ax1(self.Otsu)
            ...
            if "移动平均" == item.text(0):
                try:
                    ...
                    self.ma = ImageFunctions(self.now_img).ma()
                    self.change_fig1_ax1(self.ma)
            ...
            if "自适应阈值处理" == item.text(0):
                try:
                    ...
                    self.adaptiveThresh = ImageFunctions(self.now_img).adaptiveThresh()
                    self.change_fig1_ax1(self.adaptiveThresh)
            ...
            if "Sauvola最强二值化算法" == item.text(0):
                try:
                    ...
                    self.sauvola = ImageFunctions(self.now_img).sauvola()
                    self.change_fig1_ax1(self.sauvola)
            ...
            if "腐蚀" == item.text(0):
                try:
                    ...
                    self.erode = ImageFunctions(self.now_img).erode()
                    self.change_fig1_ax1(self.erode)
            ...
            if "膨胀" == item.text(0):
                try:
                    ...
                    self.dilate = ImageFunctions(self.now_img).dilate()
                    self.change_fig1_ax1(self.dilate)
            ...
            if "开运算" == item.text(0):
                try:
                    ...
                    self.opening = ImageFunctions(self.now_img).opening()
                    self.change_fig1_ax1(self.opening)
            ...
            if "闭运算" == item.text(0):
                try:
                    ...
                    self.closing = ImageFunctions(self.now_img).closing()
                    self.change_fig1_ax1(self.closing)
            ...
            if "复古特效" == item.text(0):
                try:
                    ...
                    self.memory = ImageFunctions(self.now_img).memory()
                    self.change_fig1_ax1(self.memory)
            ...
            if "流年特效（红）" == item.text(0):
                try:
                    self.change_fig1_ax1(self.yearpass_red)
                except:
                    self.yearpass_red = ImageFunctions(self.now_img).yearpass()
                    self.change_fig1_ax1(self.yearpass_red)
                    self.main_Window.ui.yearpass_red = QtWidgets.QAction(self.main_Window)
                    self.main_Window.ui.Method_bar.addAction(self.main_Window.ui.yearpass_red)
                    self.main_Window.ui.yearpass_red.setIcon(self.get_icon_pixmap(self.yearpass_red))
                    self.main_Window.ui.yearpass_red.setText(_translate("MainWindow", "流年特效（红）"))
                    self.main_Window.ui.yearpass_red.setToolTip(_translate("MainWindow", "流年特效（红）"))
                    self.main_Window.ui.yearpass_red.triggered.connect(self.show_yearpass_red)
            if "流年特效（绿）" == item.text(0):
                try:
                    self.change_fig1_ax1(self.yearpass_green)
                except:
                    self.yearpass_green = ImageFunctions(self.now_img).yearpass_green()
                    self.change_fig1_ax1(self.yearpass_green)
                    self.main_Window.ui.yearpass_green = QtWidgets.QAction(self.main_Window)
                    self.main_Window.ui.Method_bar.addAction(self.main_Window.ui.yearpass_green)
                    self.main_Window.ui.yearpass_green.setIcon(self.get_icon_pixmap(self.yearpass_green))
                    self.main_Window.ui.yearpass_green.setText(_translate("MainWindow", "流年特效（绿）"))
                    self.main_Window.ui.yearpass_green.setToolTip(_translate("MainWindow", "流年特效（绿）"))
                    self.main_Window.ui.yearpass_green.triggered.connect(self.show_yearpass_green)
            if "流年特效（蓝）" == item.text(0):
                try:
                    self.change_fig1_ax1(self.yearpass_blue)
                except:
                    self.yearpass_blue = ImageFunctions(self.now_img).yearpass_blue()
                    self.change_fig1_ax1(self.yearpass_blue)
                    self.main_Window.ui.yearpass_blue = QtWidgets.QAction(self.main_Window)
                    self.main_Window.ui.Method_bar.addAction(self.main_Window.ui.yearpass_blue)
                    self.main_Window.ui.yearpass_blue.setIcon(self.get_icon_pixmap(self.yearpass_blue))
                    self.main_Window.ui.yearpass_blue.setText(_translate("MainWindow", "流年特效（蓝）"))
                    self.main_Window.ui.yearpass_blue.setToolTip(_translate("MainWindow", "流年特效（蓝）"))
                    self.main_Window.ui.yearpass_blue.triggered.connect(self.show_yearpass_blue)
        if self.mode==1:
            print('xmode')
            ...
            if "SSR" == item.text(0):
                self.main_Window.get_double()
                self.now_img = ImageFunctions(self.now_img).SSR(self.main_Window.sigma)
                self.change_fig1_ax1(self.now_img)
            if "直方图均衡化" == item.text(0):
    ...
    def load_img(self):
        ...
        if filename == "":print('not'),self.main_Window.ui.Method_bar.show()
            ...
            if param==[]:
                x, y, w, h = 0 + self.height * 0.05, 0 + self.width * 0.05, self.height * 0.95, self.width * 0.95
            else:
                x, y, w, h = param
                if 4 * w * h < self.size:
            ...
            if len(self.now_actions)>=6:
                ...
                self.memory=0
                self.yearpass_red=0
                self.yearpass_green=0
                self.yearpass_blue=0
    ...
    def show_memory(self):
        self.change_fig1_ax1(self.memory)
    def show_yearpass_red(self):
        self.change_fig1_ax1(self.yearpass_red)
    def show_yearpass_green(self):
        self.change_fig1_ax1(self.yearpass_green)
    def show_yearpass_blue(self):
        self.change_fig1_ax1(self.yearpass_blue)
