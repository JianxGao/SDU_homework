    ...
    * :meth:`draw_quad_mesh`
    ...
    def _iter_collection(self, gc, master_transform, all_transforms,
        ...
        *path_ids*, which is a list of arbitrary objects that the
        ...
        Each yielded results is of the form::
    ...
    def draw_image(self, gc, x, y, im, transform=None):
        ...
        transform : `matplotlib.transforms.Affine2DBase`
            ...
            applied *before* translating the results by *x* and *y* (this can
...
class GraphicsContextBase:
    ...
    def __init__(self):
        ...
        self._antialiased = 1  # use 0, 1 not True, False for extension data
        self._capstyle = 'butt'
        self._cliprect = None
        self._clippath = None
        self._dashes = 0, None
    ...
    def set_antialiased(self, b):
        ...
        # Use ints to make life easier on extension data trying to read the gc.
...
class TimerBase:
    ...
    - ``_timer_start``: Backend-specific data for starting the timer.
    - ``_timer_stop``: Backend-specific data for stopping the timer.
...
class FigureCanvasBase:
    ...
    def print_figure(
        ...
        # Some data (e.g. Figure.show) differentiates between having *no*
...
class FigureManagerBase:
    ...
    as *show* or *resize* to the GUI-specific data. Non-GUI backends do not
